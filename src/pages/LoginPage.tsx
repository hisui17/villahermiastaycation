          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {isRegister && (
              <div className="space-y-2">
                ...
                <Input id="fullName" type="text" value={fullName} onChange={(e) => setFullName(e.target.value)} required placeholder="Juan Dela Cruz" />
              </div>
            )}
            <div className="space-y-2">
              <Label htmlFor="email">Gmail Account</Label>
              <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="admin@gmail.com" />
            </div>
            <div className="space-y-2">
